...
class CreateBlogInputDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 15 }, description: { required: true, type: () => String, maxLength: 500 }, websiteUrl: { required: true, type: () => String, maxLength: 100, pattern: "/^https:\\/\\/([a-zA-Z0-9_-]+\\.)+[a-zA-Z0-9_-]+(\\/[a-zA-Z0-9_-]+)*\\/?$/" } };
    }
}
